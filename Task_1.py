...
def GetData(data_params, saveToPkl):
    ...
    # sorting the folders alphabetically
...
if __name__ == '__main__':
    ...
    data_path = 'C:\\Users\\idofi\\OneDrive\\Documents\\BGU\\masters\\year A\\computer vision\\Task_1\\101_ObjectCategories'  # please enter path to 101_ObjectCategories directory
